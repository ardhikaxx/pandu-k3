...
@section('page-title', 'Pengawasan Divisi')
...
<div class="row g-4 mb-4">
  <div class="col-md-4">
    <div class="pandu-card p-4">
      <div class="d-flex justify-content-between">
        <div>
          <p class="text-secondary small fw-bold text-uppercase mb-1">Perlu Verifikasi</p>
          <h2 class="fw-bold mb-0">{{ $stats['my_verifications'] }}</h2>
        </div>
  ...
  <div class="col-md-4">
    <div class="pandu-card p-4">
      <div class="d-flex justify-content-between">
        <div>
          <p class="text-secondary small fw-bold text-uppercase mb-1">Tugas CAPA</p>
          <h2 class="fw-bold mb-0">{{ $stats['my_capa'] }}</h2>
        </div>
    ...
    <div class="pandu-card p-4">
      <div class="d-flex justify-content-between">
        <div>
          ...
          <h2 class="fw-bold mb-0">{{ $stats['my_inspections'] }}</h2>
        </div>
